...
RUN cd /home/vj4 && sed -i -e 's/aiohttp>=2.0.7/aiohttp==2.2.0/g' requirements.txt && python3 -m pip install -r requirements.txt && npm install && \
...
cd /home/vj4 && python3 -m vj4.server --listen http://0.0.0.0:8888\n\
